...
<img src="../图片资源/logo.png" width="120" alt="Kaleido Logo" />
...
<div align="center">
  <img src="../图片资源/%E4%B8%9A%E5%8A%A1%E5%8A%9F%E8%83%BD.jpg" width="800" alt="业务功能"/>
</div>
...
### 🛠️ 技术栈
<div align="center">
  <img src="../图片资源/%E6%8A%80%E6%9C%AF%E6%A0%88.jpg" width="800" alt="业务功能"/>
</div>
...
### 系统架构
<div align="center">
  <img src="../图片资源/%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84.jpg" width="800" alt="系统架构"/>
</div>

### 业务架构
<div align="center">
  <img src="../图片资源/%E4%B8%9A%E5%8A%A1%E6%9E%B6%E6%9E%84.jpg" width="800" alt="业务架构"/>
</div>

### 代码分层设计
<div align="center">
  <img src="../图片资源/%E5%88%86%E5%B1%82%E6%9E%B6%E6%9E%84.jpg" width="800" alt="代码分层设计"/>
</div>
<div align="center">
  <img src="../图片资源/%E7%9B%AE%E5%BD%95%E7%BB%93%E6%9E%84.png" width="800" alt="目录结构"/>
</div>
...
│   │   ├── kaleido-common/            # 公共模块（20 个）
│   │   │   ├── kaleido-api/           # RPC 接口与 DTO
│   │   │   ├── kaleido-base/          # 基础工具类
│   │   │   ├── kaleido-cache/         # 多级缓存
│   │   │   ├── kaleido-ds/            # 数据源与分库分表
│   │   │   ├── kaleido-lock/          # 分布式锁
...
│   │   │   └── ...                    # aop / file / job / limiter / sms 等
│   │   ├── kaleido-gateway/           # API 网关（9010）
│   │   ├── kaleido-auth/              # 认证授权服务
│   │   ├── kaleido-admin/             # 管理后台服务
│   │   ├── kaleido-notice/            # 通知服务
│   │   ├── kaleido-biz/               # 业务服务集合
│   │   │   ├── kaleido-wardrobe/      # 衣柜服务（核心领域）
│   │   │   ├── kaleido-ai/            # AI 服务（Spring AI）
│   │   │   ├── kaleido-user/          # 用户服务
│   │   │   ├── kaleido-coin/          # 金币服务
│   │   │   ├── kaleido-tag/           # 标签服务
│   │   │   ├── kaleido-recommend/     # 推荐服务
│   │   │   ├── kaleido-interview/     # AI 面试服务（LangChain4j）
│   │   │   ├── kaleido-message/       # 消息可靠投递
│   │   │   └── kaleido-mcp/           # MCP 服务
│   │   ├── pom.xml                    # 父 POM
│   │   ├── LICENSE
│   │   └── .gitignore
│   │
│   └── frontend/                      # 管理后台前端
│       ├── src/                       # Vue 3 + Element Plus + Vite 6
│       ├── public/
│       ├── mock/
│       └── package.json
│
└── 项目文档/
    ├── API文档/                       # smart-doc 生成的接口文档
    ├── 部署文档/                      # 运维与配置
    │   ├── dev-ops/                   # Docker Compose 基础环境（18 个容器）
    │   ├── Nacos配置/                 # Nacos 配置中心导出
    │   └── init_env.bat               # 环境变量初始化脚本
    ├── 数据库设计/                    # 建表 SQL（kaleido / seata / xxl-job / interview）
    ├── 项目介绍/                      # 项目说明与架构教程
    │   └── 教程文章/
    └── 图片资源/                      # 架构图、流程图、截图
```
...
- **Gitee (国内推荐)**
  ```bash
  git clone https://gitee.com/tomhui/kaleido-ai.git
  ```

- **GitHub**
  ```bash
  git clone https://github.com/tomhui/kaleido-ai.git
  ```
...
3. 点击 **导入配置**，选择文件：`../部署文档/Nacos配置/nacos_config_export.zip`。
...
1. **修改** ：修改 `../部署文档/init_env.bat` 脚本，将配置替换为自己的，主要修改ip地址、minio密钥与模型的配置信息。AI 的 API 调用默认使用硅基流动，替换为你自己的模型服务地址与密钥即可。
2. **执行**: 双击运行或在终端执行该脚本。
