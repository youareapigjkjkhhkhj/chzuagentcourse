...
public final class IdempotentConsumeAspect {
     ...
     */
    @Around("@annotation(com.example.ai.ragent.framework.idempotent.IdempotentConsume)")
    public Object idempotentConsume(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 如果已有消费中状态，提示延迟消费；已完成则直接跳�?        boolean errorFlag = IdempotentConsumeStatusEnum.isError(absentAndGet);
        if (errorFlag) {
