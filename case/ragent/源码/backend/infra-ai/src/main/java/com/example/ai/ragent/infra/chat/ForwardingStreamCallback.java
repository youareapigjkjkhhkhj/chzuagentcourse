...
/**
 * 透传�?StreamCallback 装饰�? * <p>
 * onContent / onThinking 直接透传 delegate，onComplete / onError 透传�?CAS-once
 * 触发 {@link #onFinish(boolean, Throwable)}，便�?trace、计量等场景在流式终态做收尾
 */
public abstract class ForwardingStreamCallback implements StreamCallback {
    ...
    /**
     * 流式响应到达「第一�?onContent」时触发一次，常用于记录用户感知首�?TTFT
     * 默认空实�?     */
