...
import com.example.ai.ragent.framework.errorcode.BaseErrorCode;
...
public class RoutingLLMService implements LLMService {
    ...
    private static final String STREAM_INTERRUPTED_MESSAGE = "流式请求被中�?;
    private static final String STREAM_NO_PROVIDER_MESSAGE = "无可用大模型提供�?;
    ...
    private static final String STREAM_NO_CONTENT_MESSAGE = "流式请求未返回内�?;
    private static final String STREAM_ALL_FAILED_MESSAGE = "大模型调用失败，请稍后再�?..";
    ...
    public StreamCancellationHandle streamChat(ChatRequest request, StreamCallback callback) {
        ...
        // 所有模型都失败了，通知客户端错�?        throw notifyAllFailed(callback, lastError);
    }
    ...
    private Throwable buildLastErrorAndLog(ProbeStreamBridge.ProbeResult result, ModelTarget target, String label) {
        switch (result.getType()) {
            case ERROR -> {
                ...
                log.warn("{} 失败模型: modelId={}, provider={}，原�? 流式请求失败，切换下一个模�?,
