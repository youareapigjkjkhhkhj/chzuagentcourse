...
package com.example.ai.ragent.infra.http;
...
/**
 * 模型URL解析�? * 用于解析AI模型的完整URL地址，支持从候选模型配置或提供商配置中获取URL
 */
...
public class ModelUrlResolver {
     ...
     *
     * @param provider   提供商配置，包含基础URL和端点配�?     * @param candidate  候选模型配置，可能包含自定义URL
     * @param capability 模型能力类型，用于确定使用哪个端�?     * @return 完整的模型URL地址
    ...
    /**
     * 拼接基础URL和路�?     * 智能处理URL和路径之间的斜杠，确保拼接结果正�?     *
     * @param baseUrl 基础URL
     * @param path    路径
     * @return 拼接后的完整URL
     */
