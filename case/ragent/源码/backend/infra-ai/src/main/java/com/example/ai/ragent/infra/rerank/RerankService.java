 ...
 * 按“和 query 的相关度”重新排序，并只返回�?topN �? */
public interface RerankService {

    /**
     * 对向量检索出来的一批候选文档进行精排，按“和 query 的相关度”重新排序，并只返回�?topN �?     *
     * @param query      用户问题
     * @param candidates 向量检索出来的一批候选文档（通常�?topK �?3~5 倍）
     * @param topN       最终希望保留的条数（喂给大模型�?K�?     * @return 经过精排后的�?topN 条文�?     */
