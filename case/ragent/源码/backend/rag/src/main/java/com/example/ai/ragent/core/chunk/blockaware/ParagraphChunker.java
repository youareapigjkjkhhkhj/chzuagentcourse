...
import com.example.ai.ragent.core.chunk.text.TextSplitter;
...
/**
 * 段落 chunker：优先整段保留，超出容忍上限才按块大小降级切�? * <p>
 * 切分一律委�?{@link TextSplitter}，由它做边界回溯（换�?/ 中文句末 / 英文句末）与文本归一�? * （URL 断行修复、CJK 软换行合并），本类不自行按下标截�? */
@Component
