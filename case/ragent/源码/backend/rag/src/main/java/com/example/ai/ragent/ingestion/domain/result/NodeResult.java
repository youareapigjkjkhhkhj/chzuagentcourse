...
package com.example.ai.ragent.ingestion.domain.result;
...
/**
 * 节点执行结果实体�? * 表示管道中单个节点执行完成后的结果信息，包含执行状态、是否继续执行后续节点等信息
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
