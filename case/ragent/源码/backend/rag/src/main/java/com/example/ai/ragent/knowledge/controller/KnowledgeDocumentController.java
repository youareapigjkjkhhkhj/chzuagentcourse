...
package com.example.ai.ragent.knowledge.controller;
...
import com.example.ai.ragent.knowledge.support.IngestionSpecSchemaProvider;
...
public class KnowledgeDocumentController {
    ...
    /**
     * 查询摄取配置的表�?schema：描述的正是上传与更新接口里�?{@code ingestionSpec} 字段
     */
    ...
    /**
     * 删除文档：逻辑删除。可选同时删除向量库中该文档的所�?chunk
     */
