...
package com.example.ai.ragent.knowledge.enums;
...
public enum SourceType {
    ...
    /**
     * 根据值获取枚�?     *
     * @param value 来源类型�?     * @return 对应的枚举，如果未找到返�?null
     */
    public static SourceType fromValue(String value) {
        ...
        // 兼容多种文件类型的别�?        if ("file".equals(normalized) || "localfile".equals(normalized) || "local_file".equals(normalized)) {
            return FILE;
        }
