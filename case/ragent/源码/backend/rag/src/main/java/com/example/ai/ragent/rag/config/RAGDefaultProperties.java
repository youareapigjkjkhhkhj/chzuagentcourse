 ...
 *
 * <p>
 * 用于管理 RAG 系统的默认向量数据库配置，包括集合名称、向量维度和度量类型�? * </p>
 *
 * <pre>
 * 示例配置�? *
 * rag:
...
public class RAGDefaultProperties {
     ...
     * 默认向量集合名称
     * <p>
     * 用于指定在向量数据库中存储向量数据的默认集合（Collection）名�?     */
    private String collectionName;

    /**
     * 向量维度
     * <p>
     * 指定向量的维数，需要与所使用�?Embedding 模型输出维度保持一�?     * 例如�?048�?096 �?     */
     ...
     * SSE 全局超时时间（毫秒）
     * <p>
     * 兜底防止 SSE 连接泄漏，超时后自动关闭连接。默�?5 分钟
     */
