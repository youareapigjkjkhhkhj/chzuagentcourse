...
public @interface ValidMemoryConfig {
     ...
     * 验证失败时的默认错误消息
     * <p>
     * JSR-303 规范强制要求此方法，即使�?Validator 中自定义了错误消息也必须保留
     * </p>
     */
    String message() default "记忆配置不合�?;

    /**
     * 验证分组
     * <p>
     * JSR-303 规范强制要求此方法，用于支持分组验证场景（如：创建时验证、更新时验证�?     * 即使当前不使用分组验证，也必须保留此方法
     * </p>
     */
