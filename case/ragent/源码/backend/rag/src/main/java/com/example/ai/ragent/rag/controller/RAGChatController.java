...
import com.example.ai.ragent.framework.idempotent.IdempotentSubmit;
...
public class RAGChatController {
     ...
     */
    @IdempotentSubmit(
            key = "T(com.example.ai.ragent.framework.context.UserContext).getUserId()",
