 ...
 *     <li>并行分类：按 Domain 拆分意图，并行调用多�?LLM 完成识别（适用于意图数量多场景�?/li>
 * </ul>
 */
public interface IntentClassifier {
     ...
     *
     * @param question 用户问题
     * @return �?score 从高到低排序的节点打分列�?     */
    List<NodeScore> classifyTargets(String question);

    /**
     * 取前 topN 个且 score >= minScore 的分�?     *
     * @param question 用户问题
     * @param topN     最多返�?N 个结�?     * @param minScore 最低分数阈�?     * @return 过滤后的节点打分列表
     */
