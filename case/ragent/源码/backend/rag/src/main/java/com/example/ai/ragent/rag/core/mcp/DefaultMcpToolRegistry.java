...
public class DefaultMcpToolRegistry implements McpToolRegistry {
    ...
    /**
     * 工具执行器存�?     * key: toolId, value: executor
     */
    private final Map<String, McpToolExecutor> executorMap = new HashMap<>();

    /**
     * Spring 容器中的所�?McpToolExecutor Bean（自动注入）
     */
