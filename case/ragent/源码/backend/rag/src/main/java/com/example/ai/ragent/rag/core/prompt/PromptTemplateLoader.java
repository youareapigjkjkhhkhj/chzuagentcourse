...
/**
 * 提示模板加载�? * 负责从类路径下加载提示模板文件，并支持模板变量填充功�? */
@Slf4j
@Service
...
public class PromptTemplateLoader {
     ...
     * @return 模板内容字符�?     * @throws IllegalArgumentException 当路径为空时抛出
    ...
    /**
     * 加载模板文件中指�?section 的原始内�?     *
     * @param path    模板文件路径
     * @param section section 名称（对�?{@code --- section: name ---} 中的 name�?     * @return section 的原始模板内�?     * @throws IllegalStateException �?section 不存在时抛出
     */
     ...
     * 从资源路径读取模板内�?     *
     * @param path 模板文件路径
     * @return 模板内容字符�?     * @throws IllegalStateException 当模板文件不存在或读取失败时抛出
     */
