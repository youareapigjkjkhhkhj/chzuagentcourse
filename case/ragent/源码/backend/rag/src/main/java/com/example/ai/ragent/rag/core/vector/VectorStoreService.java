...
public interface VectorStoreService {
    ...
    /**
     * 批量建立文档的向量索�?     *
     * @param collectionName 向量空间名称（知识库 collectionName�?     * @param docId          文档唯一标识
     * @param chunks         文档切片列表，须包含已计算好�?embedding
     */
     ...
     * 删除指定的单�?chunk 向量索引
     *
     * @param collectionName 向量空间名称（知识库 collectionName�?     * @param chunkId        chunk 的唯一标识
     */
    void deleteChunkById(String collectionName, String chunkId);

    /**
     * 批量删除指定 chunk 的向量索�?     *
     * @param collectionName 向量空间名称（知识库 collectionName�?     * @param chunkIds       chunk 唯一标识列表
     */
