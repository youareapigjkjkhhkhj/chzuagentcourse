...
import com.example.ai.ragent.rag.controller.request.ConversationUpdateRequest;
import com.example.ai.ragent.rag.controller.vo.ConversationVO;
...
import com.example.ai.ragent.rag.service.ConversationService;
import com.example.ai.ragent.rag.service.bo.ConversationCreateBO;
...
public class ConversationServiceImpl implements ConversationService {
    ...
    public void rename(String conversationId, ConversationUpdateRequest request) {
        ...
        if (title.length() > maxLen) {
            throw new ClientException("会话名称长度不能超过" + maxLen + "个字�?);
        }
