...
import static com.example.ai.ragent.rag.constant.RAGConstant.CONVERSATION_TITLE_PROMPT_PATH;

/**
 * 会话标题生成�? * <p>
 * 拆为独立 bean 是为了让 Spring AOP �?{@link RagTraceNode} 拦截生效�? * 同类 self-call 不会触发 proxy，所以原 ConversationServiceImpl 内部直接�? * private 方法时，标题生成�?LLM 调用无法挂在 trace 节点下，会变成孤立的 root 节点
 */
@Slf4j
@Component
